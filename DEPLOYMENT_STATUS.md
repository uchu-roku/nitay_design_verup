...
### コミット情報
- **コミットID**: 98feb6e (ドキュメント追加)
- **主要修正**: fd043df (KEYCODE構造修正)
- **日時**: 2026年2月4日 23:15
...
1. **98feb6e** (2026/02/04 23:15) - ドキュメント追加
2. **fd043df** (2026/02/04 23:10) - KEYCODE構造修正、レイヤーファイル名変更
3. **b5059c7** (2026/02/04 22:50) - 市町村コードマッピング追加
4. **98b4db2** (2026/02/04) - デプロイトリガー
